...
/**
 * ChatGPT에게 메시지를 보내고 응답을 받는 함수
 */
export async function getChatGPTResponse(userMessage: string, systemPrompt?: string): Promise<string> {
  try {

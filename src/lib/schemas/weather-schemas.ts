...
export const dailyWeatherInputSchema = z.object({
  ...
  rainProbability: z.number().min(0).max(100).optional().default(0),
  units: z.enum(['metric', 'imperial']).default('metric'),
  dayWeather: z.record(z.string(), z.any()).optional().nullable(),
  nightWeather: z.record(z.string(), z.any()).optional().nullable(),
  headline: z.record(z.string(), z.any()).optional().nullable(),
